...
MIGRATION_MODULES = {"sites": "vent_your_rent.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "vent_your_rent.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Common Knowledge""", "hello@commonknowledge.coop")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "vent_your_rent.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "vent_your_rent.users.adapters.SocialAccountAdapter"
